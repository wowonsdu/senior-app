...
- [ ] 9.10.4 Measurements: voice input — bez retry na NO_MATCH (error 7) + bez retry dla pustych wynikow
...
- [ ] 9.11.8 Patient Home: voice input — bez retry na NO_MATCH (error 7) + bez retry dla pustych wynikow

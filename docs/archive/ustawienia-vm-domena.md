...
- Brak rozwijania dla danych pacjenta; choroby i leki zawsze widoczne
...
- Spójne dane dla list chorob i lekow
...
- [x] Utrzymac listy chorob i lekow jako stale widoczne w stanie UI

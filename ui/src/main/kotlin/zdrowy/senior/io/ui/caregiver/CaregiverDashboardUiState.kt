...
data class CaregiverDashboardUiState(
    ...
    val newItems: List<CaregiverMeasurementNotificationUi>,
    val readItems: List<CaregiverMeasurementNotificationUi>,
    val showMissingPatient: Boolean
) {
    val newCount: Int = newItems.size

    fun visibleItems(): List<CaregiverMeasurementNotificationUi> {

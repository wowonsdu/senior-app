...
class PatientSugarDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.sugarDialogVoice.voiceInputMic.setOnClickListener {
            startSpeechToText()
        }
        binding.sugarDialogVoice.root.visibility = if (editMode) View.GONE else View.VISIBLE
    ...
    private fun startSpeechToTextInternal(isRestart: Boolean = false, delayMs: Long = 0L) {
        ...
        binding.sugarDialogVoice.voiceInputLabel.setText(R.string.patient_home_voice_title)
        setRecordingActive(true)
    ...
    private fun setTextFromResults(results: Bundle?) {
        ...
        if (text.isNotBlank()) {
            ...
            binding.sugarDialogValue.setText(number)
        }
    }
    ...
    private fun showNoSpeechHint() {
        binding.sugarDialogVoice.voiceInputLabel.text =
    ...
    private fun setRecordingActive(isActive: Boolean) {
        binding.sugarDialogVoice.voiceInputLabel.isVisible = !isActive
        binding.sugarDialogVoice.voiceInputBadge.isVisible = isActive
        binding.sugarDialogVoice.voiceInputProgress.isVisible = isActive
        if (isActive) {
    ...
    private fun startRecordingAnimation() {
        val dot = binding.sugarDialogVoice.voiceInputBadgeDot
    ...
    private fun stopRecordingAnimation() {
        ...
        binding.sugarDialogVoice.voiceInputBadgeDot.alpha = 1f
    }
